...
namespace WebApplication1.Controllers
{
    public class GuestbooksController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,Content,CreaTime")] Guestbook guestbook)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,Content,CreaTime")] Guestbook guestbook)
        {
            if (ModelState.IsValid)
            {
